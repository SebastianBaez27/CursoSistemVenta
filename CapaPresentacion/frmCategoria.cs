    ...
    public partial class frmCategoria : Form
    {
        ...
        private void btnguardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (resultado)
                {
                    ...
                    row.Cells["Id"].Value = obj.IdCategoria;  //txtindice.Text;
        ...
        private void dgvdata_CellPainting(object sender, DataGridViewCellPaintingEventArgs e)
        {
            ...
            if (e.ColumnIndex == 0)
            {
                ...
                // Imagen original
                var img = Properties.Resources.CheckLogo;
        ...
        private void btneliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                if (MessageBox.Show("Desseas eliminar la categoria", "Mensaje", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    string mensaje = string.Empty;
